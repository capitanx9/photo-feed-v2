...
help:
	...
	@echo ""
	@echo "Approve (dev):"
	@echo "  dev-approve-all      Flip every pending order to paid"
	@echo ""
	...
	@echo "  stage-wipe           Nuke stage DB (keeps superusers)"
	...
	@echo "  stage-approve-all    Flip every pending order to paid on stage"
